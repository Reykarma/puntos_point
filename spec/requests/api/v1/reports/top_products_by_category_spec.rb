...
describe "API V1 Reports - Top Products by Category", type: :request do
  context "GET /api/v1/reports/top_products_by_category" do
    it "returns the top products by category" do
      puts "Starting test: returns the top products by category"
      ...
      puts "Sending GET request to /api/v1/reports/top_products_by_category"
      get "/api/v1/reports/top_products_by_category", {}, headers
      ...
      puts "Test completed: returns the top products by category"
    end

    it "returns unauthorized without a valid token" do
      puts "Starting test: returns unauthorized without a valid token"

      puts "Sending GET request to /api/v1/reports/top_products_by_category without token"
